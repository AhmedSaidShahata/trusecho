    ...
    <table class="table table-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="d-flex">
                <div hidden>{{!$check_status=App\Blog::where('lang', '=',App::getlocale())->get()->first()->status}}</div>
                    <input  type="checkbox" data-blogid="{{$blog->id}}" class="accept-blog btn btn-primary">
